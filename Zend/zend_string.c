...
ZEND_API extern inline zend_string *zend_string_extend(zend_string *s, size_t len, bool persistent);
ZEND_API extern inline zend_string *zend_string_truncate(zend_string *s, size_t len, bool persistent);
...
ZEND_API extern inline void zend_string_release_ex(zend_string *s, bool persistent);
...
ZEND_API extern inline bool zend_string_starts_with_cstr(const zend_string *str, const char *prefix, size_t prefix_length);
ZEND_API extern inline bool zend_string_starts_with(const zend_string *str, const zend_string *prefix);
ZEND_API extern inline bool zend_string_starts_with_cstr_ci(const zend_string *str, const char *prefix, size_t prefix_length);
ZEND_API extern inline bool zend_string_starts_with_ci(const zend_string *str, const zend_string *prefix);
